...
Public Declare Function RegQueryInfoKeyW Lib "advapi32" _
    (ByVal hKey As Long, _
     ByVal lpClass As Long, _
     ByVal lpcClass As Long, _
     ByVal lpReserved As Long, _
     ByVal lpcSubKeys As Long, _
     ByVal lpcMaxSubKeyLen As Long, _
     ByVal lpcMaxClassLen As Long, _
     ByVal lpcValues As Long, _
     ByVal lpcMaxValueNameLen As Long, _
     ByVal lpcMaxValueLen As Long, _
...
Public Declare Function RegEnumValueW Lib "advapi32" _
    (ByVal hKey As Long, _
     ByVal dwIndex As Long, _
     ByVal lpValueName As Long, _
     lpcchValueName As Long, _
     ByVal lpReserved As Long, _
